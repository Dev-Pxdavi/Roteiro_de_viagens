//bíblioteca e códigos de terceiros 
...
const criaHorasSelecao = () => {
  ...
  for(let i = 6; i < 23; i++) {
   ...
   horaDisponiveis += `<option value="${hora}:00">${hora}:00</option>`
   horaDisponiveis += `<option value="${hora}:30">${hora}:30</option>`
